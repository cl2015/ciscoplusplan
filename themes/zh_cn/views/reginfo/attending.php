...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->radioButtonList($model,'is_online',$model->getOnlineOptions($this->close),array('separator'=>'', 'template' =>'<li class="q6" style="list-style: none outside none;display:block; width:600px;float:none;">{input} {label}</li>', 'labelOptions' => array('style' => 'display:inline;'))); ?>
