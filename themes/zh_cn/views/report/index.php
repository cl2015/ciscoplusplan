...
<td>&nbsp;<?php echo $row['ec_mobile']>0?round($row['nomination']/$row['ec_mobile']*100,2):'0'?>%</td>
<td>&nbsp;<?php echo $row['registeration']?></td>
<td>&nbsp;<?php echo $row['nomination']>0?round($row['registeration']/$row['nomination']*100,2):'0'?>%</td>
