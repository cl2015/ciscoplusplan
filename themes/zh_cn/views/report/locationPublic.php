...
<h1>Daily Report - Location Nomination</h1>
<ul>
...
<div id="tableBox">
	<table class="mytable"  style="width: 986px; margin-left: -39px;">
		<tr>
			...
			<th style="width: 100px;">Public Online (Free)</th>
			<th style="width: 100px;">Public Onsite (Payment)</th>
			<th style="width: 100px;">Public Onsite (Paid)</th>
		</tr>
		<?php 
