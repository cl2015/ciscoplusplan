...
class User extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('has_code, code, email,organisation, relation_with_cisco, full_name, job_title, department, working_phone_dis, working_phone, mobile, province, city, ec_name, ec_relationship, ec_mobile', 'required'),
