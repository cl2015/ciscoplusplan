...
class User extends TrackStarActiveRecord {
    ...
    public function rules() {
        ...
        $rules = array(
            ...
            array('email', 'required', 'on' => 'loading'),
            array('mobile', 'length', 'max' => 11,'on' => 'update,surveyUpdate,employeeUpdate'),
            array('mobile', 'length', 'min' => 11,'on' => 'update,surveyUpdate,employeeUpdate'),
    ...
    public function getDepartmentOptions() {
        return array(
            ...
            '采购' => Yii::t('default','采购'),
            '决策管理' => Yii::t('default','决策管理'),
            '客户服务' => Yii::t('default','客户服务'),
            '业务部门' => Yii::t('default','业务部门'),
            '网络管理' => Yii::t('default','网络管理'),
            '信息化管理' => Yii::t('default','信息化管理'),
            '研究/开发' => Yii::t('default','研究/开发'),
            '其他' => Yii::t('default','其他'),
        );
    }
