...
class Report extends CFormModel {
	...
	public function updateLocation(){
		...
		$result = $dbCommand->update('users', array('map_loca'=>'Central'),"province = 'jiangxi'");
		$result = $dbCommand->update('users', array('map_loca'=>'Central'),"province = '安徽'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '北京'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = 'Beijing'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '大连'");
		$result = $dbCommand->update('users', array('map_loca'=>'South'),"province = '福建'");
		$result = $dbCommand->update('users', array('map_loca'=>'South'),"province = '福州'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = '甘肃'");
		$result = $dbCommand->update('users', array('map_loca'=>'South'),"province = '广东'");
		$result = $dbCommand->update('users', array('map_loca'=>'South'),"province = '广西'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = '贵州'");
		$result = $dbCommand->update('users', array('map_loca'=>'South'),"province = '海南'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '河北'");
		$result = $dbCommand->update('users', array('map_loca'=>'Central'),"province = '河南'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '黑龙江'");
		$result = $dbCommand->update('users', array('map_loca'=>'Central'),"province = '湖北'");
		$result = $dbCommand->update('users', array('map_loca'=>'Central'),"province = '湖南'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '吉林'");
		$result = $dbCommand->update('users', array('map_loca'=>'East'),"province = '江苏'");
		$result = $dbCommand->update('users', array('map_loca'=>'Central'),"province = '江西'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '辽宁'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '聊城'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '内蒙古'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = '宁夏'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '青岛'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = '青海'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '山东'");
		$result = $dbCommand->update('users', array('map_loca'=>'Central'),"province = '山西'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = '陕西'");
		$result = $dbCommand->update('users', array('map_loca'=>'East'),"province = '上海'");
		$result = $dbCommand->update('users', array('map_loca'=>'South'),"province = '深圳'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = '四川'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '天津'");
		$result = $dbCommand->update('users', array('map_loca'=>'East'),"province = '温州'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = '西安'");
		$result = $dbCommand->update('users', array('map_loca'=>'South'),"province = '香港'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = '新疆'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = '云南'");
		$result = $dbCommand->update('users', array('map_loca'=>'East'),"province = '浙江'");
		$result = $dbCommand->update('users', array('map_loca'=>'Central'),"province = '郑州'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = '重庆'");
		$result = $dbCommand->update('users', array('map_loca'=>'(blank)'),"province = '(blank)'");
		$result = $dbCommand->update('users', array('map_loca'=>'East'),"province = 'Shanghai'");
		$result = $dbCommand->update('users', array('map_loca'=>'North'),"province = '内蒙'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = '西藏'");
		$result = $dbCommand->update('users', array('map_loca'=>'West'),"province = 'Yunnan'");
