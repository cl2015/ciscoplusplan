...
class Survey extends TrackStarActiveRecord {
	...
	public function getQ5Options(){
		return array(
                ...
                1 => Yii::t('default','Aerospace & Defence'),
                2 => Yii::t('default','Agriculture'),
                3 => Yii::t('default','Automotive'),
                4 => Yii::t('default','BPO/Call Center'),
                5 => Yii::t('default','Banking'),
                6 => Yii::t('default','Chemical & Petroleum'),
                7 => Yii::t('default','Computer Hardware'),
                8 => Yii::t('default','Computer Software & Services'),
                9 => Yii::t('default','Consumer Products'),
                10 => Yii::t('default','Education'),
                11 => Yii::t('default','Electronics'),
                12 => Yii::t('default','Financial Services'),
                13 => Yii::t('default','Food, Beverage & Tobacco'),
                14 => Yii::t('default','Government'),
                15 => Yii::t('default','Healthcare'),
                16 => Yii::t('default','Hospitality (Hotels & Leisure)'),
                17 => Yii::t('default','Insurance'),
                18 => Yii::t('default','Legal'),
                19 => Yii::t('default','Manufacturing'),
                20 => Yii::t('default','Marketing, PR, Advertising'),
                21 => Yii::t('default','Media - Broadcast'),
                22 => Yii::t('default','Media - Print'),
                23 => Yii::t('default','Wholesale/Distribution'),
                24 => Yii::t('default','Pharmaceutical & Biotechnology'),
                25 => Yii::t('default','Professional & Consulting Services'),
                26 => Yii::t('default','Property & Construction'),
                27 => Yii::t('default','Retail'),
                28 => Yii::t('default','Service Provider/Telecommunications'),
                29 => Yii::t('default','Transportation'),
                30 => Yii::t('default','Utilities & Energy'),
                31 => Yii::t('default','Other'),
            );
